...
>
    ...
    <div class="flex flex-wrap -mx-3 mb-2">
      <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
        ...
        <input
          ...
          id="bounty"
          type="number"
          placeholder="Enter Bounty Number"
          name="bounty"
          bind:value={bounty}
        />
      </div>
      <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
        <label
          ...
          for="square"
        >
          Enter the number whose square root is bounty
        </label>
        <input
          class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
          id="square"
  ...
  {#if form?.success}
    ...
    <p class="pt-2">A Bounty has deploy successfully : <a href={form?tx}>Transaction link!</a></p>
  {/if}
</div>